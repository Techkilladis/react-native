...
const SubscriptionCard = ({name, price, currency, icon, startDate, status, billing,
                              color, category, plan,paymentMethod, renewalDate,
                              expanded, onPress}: SubscriptionCardProps) => {
    return (
